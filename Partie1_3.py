...
from tensorflow.keras.layers import Input, Dense, Conv2D, Dropout, Softmax, MaxPooling2D, Flatten
...
# Couches de convolution2D puis MaxPooling2D et Dropout est elimine
model = Sequential()
